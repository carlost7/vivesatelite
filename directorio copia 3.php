...
<div id="tab-container" class='tab-container'>
    ...
    $c_sub+=1;
    ?>
    <li class='tab'><a href="directorio.php?id_scat=<?=$row_directorio_subcategoria['ID'];?>#tabs1-<? echo $c_sub; ?>"><?=$row_directorio_subcategoria['subcategoria'];?></a></li>
    <? } ?>
	</ul>
    <div class='panel-container'>
        ...
        $query_result_directorio=mysql_query($query_directorio, $db_conexion) or die (mysql_error());	?>
            ...
            <td align="center">Información Online</td>
            </tr>
        ...
        <?
        echo $query_directorio =  "SELECT * FROM `directorio` JOIN clientes ON directorio.id_cliente=clientes.ID WHERE id_categoria='$id_cat' AND id_subcategoria='$c_tabs' AND clientes.status='1' AND directorio.status='1' ORDER BY clientes.Nombre";
        //Resultados de la consulta
        $query_result_directorio=mysql_query($query_directorio, $db_conexion) or die (mysql_error());	?>
