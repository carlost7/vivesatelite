...
Lightbox.prototype = {
	...
	updateDetails: function() {
		...
		if(elementArray.length > 1){
			...
			if(elementArray[activeElement][0].endsWith('swf')) { // SWF
				Element.setInnerHTML( 'numberDisplay', "Película " + eval(activeElement + 1) + " de " + elementArray.length);
			}else{ // Image
				Element.setInnerHTML( 'numberDisplay', "Foto " + eval(activeElement + 1) + " de " + elementArray.length);			
			}
		}
