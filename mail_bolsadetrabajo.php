...
<?PHP
$query =  "SELECT * FROM clasificados  WHERE `Status`='S' ORDER BY RAND()";
...
if (strstr($descripcion,$palabra)){
            return "si";
}else{
            
}

	$query =  "INSERT INTO `bolsadetrabajo` (`ID` ,`Contacto` ,`Vacante` , `Vencimiento` ,`Descripcion` ,`Oferta` ,`Logo` ,`Mail` ,`Status`, hora_registro)VALUES (NULL , '$contacto', '$vacante', '$vencimiento','$descripcion', '$oferta', '', '$email', 'S','$horaRegistro')";
