...
$oferta=$_POST['oferta'];
	...
	$query =  "INSERT INTO `bolsadetrabajo` (`ID` ,`Contacto` ,`Vacante` , `Vencimiento` ,`Descripcion` ,`Oferta` ,`Logo` ,`Mail` ,`Status` )VALUES (NULL , '$contacto', '$vacante', '$vencimiento','$descripcion', '$oferta', '', '$email', 'S')";
